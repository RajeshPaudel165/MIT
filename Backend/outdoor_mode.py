...
def start_outdoor_mode():
    """Start the Outdoor Mode GUI"""
    root = tk.Tk()
    root.title("Outdoor Mode - Soil Savvy Suite")
    ...
    # Title
    title_label = ttk.Label(main_frame, text="🌲 Outdoor Mode", 
                           font=("Arial", 20, "bold"))
    title_label.grid(row=0, column=0, pady=(0, 20))
    
    # Welcome message
    welcome_label = ttk.Label(main_frame, text="Welcome to Outdoor Mode!", 
                             font=("Arial", 14))
    ...
    weather_button = ttk.Button(buttons_frame, text="🌤️ Check Weather", 
                              command=lambda: show_message("Weather monitoring feature coming soon!"))
    weather_button.grid(row=0, column=0, padx=5)
    
    # Plant Guide button  
    guide_button = ttk.Button(buttons_frame, text="🌿 Plant Guide",
                            command=lambda: show_message("Plant guide feature coming soon!"))
    guide_button.grid(row=0, column=1, padx=5)
