...
def start_casual_mode():
    """Start the Casual Mode GUI"""
    root = tk.Tk()
    root.title("Casual Mode - Soil Savvy Suite")
    ...
    # Title
    title_label = ttk.Label(main_frame, text="🌿 Casual Mode", 
                           font=("Arial", 20, "bold"))
    title_label.grid(row=0, column=0, pady=(0, 20))
    
    # Welcome message
    welcome_label = ttk.Label(main_frame, text="Welcome to Casual Mode!", 
                             font=("Arial", 14))
    ...
    features = [
        ...
        "🌤️ Basic weather notifications",
        "📊 Simple progress tracking",
        "💡 Easy care tips and suggestions"
    ]
    ...
    # Set Reminder button
    reminder_button = ttk.Button(buttons_frame, text="⏰ Set Reminder", 
                               command=lambda: show_message("Reminder feature coming soon!"))
    reminder_button.grid(row=0, column=0, padx=5)
    
    # View Tips button  
    tips_button = ttk.Button(buttons_frame, text="💡 Care Tips",
                           command=lambda: show_message("Tips feature coming soon!"))
    tips_button.grid(row=0, column=1, padx=5)
